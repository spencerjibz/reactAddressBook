     ...
     // create 5 organisations
      ...
      if(results&&Array.isArray(results)) { 
        ...
        arr.forEach((e,i)=> { 
         ...
         Storage.AddOrg(e.company.name,e.email,e.phone,e.website,undefined,[]);
...
if (name&&phone&&ContactAddress&&email&&address&&Orgs.length>0) {
Storage.AddContact(name,phone,address.city,email,ContactAddress,Orgs)
}
      }
      Storage.init()
